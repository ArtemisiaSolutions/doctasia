...
var dbProvider = new Provider(confMgr.getConfig("mongodb.name"),
    ...
    function() {
        ...
        dbProvider.loadCollection('users', function() {

        })

        dbProvider.loadCollection( 'repositories', function() {

        })

        dbProvider.loadCollection( 'buildjobs', function() {

        })

        dbProvider.loadCollection( 'work_queue', function() {

        })

        dbProvider.loadCollection( 'work_queue_archive', function() {

        })

        dbProvider.loadCollection( 'commit', function() {

        })

        dbProvider.loadCollection( 'ssh', function() {

        })

        dbProvider.loadCollection( 'worker', [
